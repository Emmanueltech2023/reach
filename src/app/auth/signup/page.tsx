...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        // Dispatch instant Brevo Welcome Email
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 border border-[#3A3A52] text-[#F5F3ED] text-sm py-3 rounded-lg hover:bg-[#1A1A2E] hover:border-[#C9A84C] transition cursor-pointer"
            >
